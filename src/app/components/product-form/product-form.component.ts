 ...
 // private router: Router,
  ...
  createProductForm(): void {
    this.productForm = this.formBuilder.group({
      ...
      categoryId: [0, Validators.min(0)], // ilgili categoryId'i al ama numerik olarak yazdır.
  ...
  add(): void {
    const request: Products = {
      ...
      supplierId: Number(this.productForm.value.supplierId) //= ...this.productForm.value ile gelen 'name' değerinin üzerin tekrar yazıyoruz (overwrite).
    };
